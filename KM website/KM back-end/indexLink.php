<?php 
    ...
    if (isset($_REQUEST['delete_id'])) {
        ...
        $delete_stmt = $db->prepare('DELETE FROM link WHERE id = :id');
...
<body>
    ...
    <div class="display-3 text-center">Update Link Page</div>
    <a href="addLink.php" class="btn btn-success mb-3">Add Data Link</a>
    <table class="table table-striped table-bordered table-hover">
        ...
        <tbody>
            <?php 
                $select_stmt = $db->prepare("SELECT * FROM link");
                $select_stmt->execute();
            ...
            ?>
                ...
                <tr>
                    ...
                    <td><a href="editLink.php?update_id=<?php echo $row["id"]; ?>" class="btn btn-warning">Edit</a></td>
