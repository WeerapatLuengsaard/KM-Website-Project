<?php 
    ...
    if (isset($_REQUEST['btn_insert'])) {
        ...
        if (empty($img)) {
            ...
            try {
                if (!isset($errorMsg)) {
                    $insert_stmt = $db->prepare("INSERT INTO shop(img, name, description, web) VALUES (:kmimg, :kmname, :kmdescription, :kmweb)");
...
<body>
    ...
    <div class="container">
    <div class="display-3 text-center">Add Data Shop</div>
