...
<body>
    ...
    <div class="display-3 text-center">Update Shop Page</div>
    <a href="addShop.php" class="btn btn-success mb-3">Add Data Shop</a>
        ...
        <tbody>
            ...
            ?>
                ...
                <tr>
                    ...
                    <td><a href="editShop.php?update_id=<?php echo $row["id"]; ?>" class="btn btn-warning">Edit</a></td>
