<?php 
    ...
    if (isset($_REQUEST['btn_update'])) {
        ...
        if (empty($img)) {
            ...
            try {
                if (!isset($errorMsg)) {
                    $update_stmt = $db->prepare("UPDATE shop SET img = :kmimg, name = :kmname, description = :kmdescription, map = :kmweb WHERE id = :id");
                    ...
                    if ($update_stmt->execute()) {
                        ...
                        header("refresh:2;indexShop.php");
                    }
                }
            } catch(PDOException $e) {
                echo $e->getMessage();
    ...
    <div class="form-group text-center">
            ...
            <div class="form-group text-center">
                <div class="col-md-12 mt-3">
                    ...
                    <a href="indexShop.php" class="btn btn-danger">Cancel</a>
                </div>
            </div>
